...
namespace EstoqueTest.MockData
{
    public class ProdutoRepositoryMock
    {
        ...
        public ProdutoRepositoryMock()
        {
            ...
            _produtos.Add(new Produto { ProdutoId = 1, Descricao = "Sorvete de Brigadeiro", Lote = 1, Quantidade = 50, DataFabricacao = DateTime.Now, DateValidade = DateTime.Now.AddDays(30) });
